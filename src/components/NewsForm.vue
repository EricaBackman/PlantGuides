<template>
    <div class="form-wrapper" v-if="!submitted" @submit-answer="onSubmit">
        <h5 class="headers">Do you want extra help on the way?</h5>
        <p>
            Sing up for our weekly reminder and we will remind you when it's time
            to water and give your plants extra love
        ...
        <form>
            <div class="form-group">
                ...
                <label id="label" for="exampleFormControlInput1">E-mail</label>
                <input
                    type="email"
                    class="form-control"
    ...
    <div class="answer-wrapper">
        <h5 class="headers">Great {{ firstName }} {{ lastName }}!</h5>
